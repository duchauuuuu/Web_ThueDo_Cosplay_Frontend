...
export default function AboutPage() {
  ...
  const galleryImages = [
    ...
    { src: "/img_clothes/anime/Boa Hancok One Piece (4)-min.jpg", alt: "Trang phục cosplay 2" },
    { src: "/img_clothes/anime/cosplay D.VA game Overwatch (2)-min.jpg", alt: "Trang phục cosplay 3" },
    { src: "/img_clothes/anime/robot AI bó sát (2)-min.jpg", alt: "Trang phục cosplay 4" },
    ...
    { src: "/img_clothes/anime/Shenhe-Cosplay-1.jpg", alt: "Trang phục cosplay 8" },
  ];
                ...
                >
                  <div className="relative w-24 h-24 flex items-center justify-center">
                    ...
                    <div className="absolute inset-0 pointer-events-none">
                      <Image
                        src="/imgSection/—Pngtree—svg fresh green round leaf_5524326.png"
                        alt="Vòng tròn xoay"
                        fill
                        sizes="96px"
